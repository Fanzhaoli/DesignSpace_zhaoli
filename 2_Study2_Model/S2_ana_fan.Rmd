...
date: "2024-12-16"
---
This is the code for new analysis of S2 data, including contour plot and 3D scatter plot. The code is organized into several sections: data preprocessing, traditional analysis, contour plot, and Gaussian smoothing.

-P: length of practices (P), 
-T: preseting time (T)
-T: time window for response (W)
...
# 导入的数据就是match条件下的
# response = 1是正确， = 2是错误
data <- bruceR::import(here::here("Study2", "data","260216.csv")) #   250419_2.csv  250418_1.csv; HCP: how was this data file generated
